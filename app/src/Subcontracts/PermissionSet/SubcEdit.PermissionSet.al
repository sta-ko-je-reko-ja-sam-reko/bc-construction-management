...
permissionset 50194 "CONS Subc - Edit"
{
    ...
    Permissions =
        tabledata "CONS Subcontract Header" = RIMD,
        tabledata "CONS Subcontract Line" = RIMD,
        tabledata "CONS Subc Claim Header" = RIMD,
        tabledata "CONS Subc Claim Line" = RIMD,
        tabledata "CONS Change Order Header" = RIMD,
        tabledata "CONS Change Order Line" = RIMD,
        ...
        tabledata "CONS Subcontracts Setup" = RIMD,
